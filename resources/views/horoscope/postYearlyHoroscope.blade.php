...
<div class="container">
    ...
    @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('rasiposted')}}" id="yearlyhoro">
                         @csrf


                          <div class="form-group">
                            <label for="rasi">{{__("horo.Select Date")}}</label>
                                <input type="number" value="2019" name="date" class="form-control" id="date">
                          </div>
                          ...
                          <div class="form-group">
                           ...
                           <label for="title">{{__("horo.Yearly Horoscope")}}</label>
...
<script>
    ...
    $(document).on('submit', '#yearlyhoro', function(e){
        e.preventDefault();
        $rasi = $("#rasi").val();
        $date = $("#date").val();
        ...
        document.getElementById("yearlyhoro").submit();
