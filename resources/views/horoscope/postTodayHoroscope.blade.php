...
<div class="container">
    ...
    @endif
        ...
        <div class="card">
                <div class="card-header">{{__("horo.Today's Horoscope")}}</div>
                <div class="card-body">
                    <form method="post" action="{{route('rasiposted')}}" id="todayhoro">
                         @csrf
                          ...
                          <div class="form-group">
                           ...
                           <label for="title">{{__("horo.Today's Horoscope")}}</label>
